...
class JSONDataTests: XCTestCase {
    ...
    func testConvertFromData_WithArrayData() {
        ...
        case .Array(let object):
            let resultData = try! JSONSerialization.dataWithJSONObject(object, options: JSONSerialization.WritingOptions())
    ...
    func testConvertFromData_WithDictionaryData() {
        ...
        case .Dictionary(let object):
            try! JSONSerialization.dataWithJSONObject(object, options: JSONSerialization.WritingOptions())
        case .Array(_):
